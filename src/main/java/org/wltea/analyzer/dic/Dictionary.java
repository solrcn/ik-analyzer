...
public class Dictionary {
    ...
    private InputStream getInputStream(final String name, final String path){
        InputStream is = Dictionary.class.getClassLoader().getResourceAsStream(path);
        if(is==null){
            is = Dictionary.class.getClassLoader().getResourceAsStream(path);
            if (is == null){
                throw new RuntimeException(name + " Dictionary not found in " + path);
            }
        }
        return is;
    }
	...
	private void loadMainDict(){
		...
		//读取主词典文件
        InputStream is = getInputStream("Main", Dictionary.PATH_DIC_MAIN);
	...
	private void loadSurnameDict(){
		...
		//读取姓氏词典文件
        InputStream is = getInputStream("Surname",Dictionary.PATH_DIC_SURNAME);
		try {
			BufferedReader br = new BufferedReader(new InputStreamReader(is , "UTF-8"), 512);
			String theWord = null;
			do {
	...
	private void loadQuantifierDict(){
		...
		//读取量词词典文件
        InputStream is = getInputStream("Quantifier", Dictionary.PATH_DIC_QUANTIFIER);
		try {
			BufferedReader br = new BufferedReader(new InputStreamReader(is , "UTF-8"), 512);
			String theWord = null;
			do {
	...
	private void loadSuffixDict(){
		...
		//读取量词词典文件
        InputStream is = getInputStream("Suffix", Dictionary.PATH_DIC_SUFFIX);
		try {
			BufferedReader br = new BufferedReader(new InputStreamReader(is , "UTF-8"), 512);
			String theWord = null;
			do {
	...
	private void loadPrepDict(){
		...
		//读取量词词典文件
        InputStream is = getInputStream("Preposition",Dictionary.PATH_DIC_PREP);
		try {
			BufferedReader br = new BufferedReader(new InputStreamReader(is , "UTF-8"), 512);
			String theWord = null;
			do {
	...
	private void loadStopWordDict(){
		...
		//读取量词词典文件
        InputStream is = getInputStream("Stopword", Dictionary.PATH_DIC_STOP);
		try {
			BufferedReader br = new BufferedReader(new InputStreamReader(is , "UTF-8"), 512);
			String theWord = null;
			do {
